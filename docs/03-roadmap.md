...
- [ ] One-week polling observation per target (01 §5) → publication latency recorded before any figure is quoted. *(2026-09-20: procedure defined in `docs/06` §6, **not run** — needs seven days of wall clock; no figure quoted.)*
