...
| `test` | pytest with sockets disabled; `tests/harness/test_goldens.py` auto-discovers every `targets/*/tests/golden/*.yaml`; `conftest.py` refuses an incomplete target at session start | C-07, C-09, C-14…C-17, C-31…C-37, C-46…C-53, C-58…C-66 |
