...
| [ADR-026](ADR-026-egress-boundary.md) | Egress boundary: coarse NetworkPolicy plus host enforcement in the fetch layer | file | amendment 1 (2026-09-23): response-body cap (64 MiB, streamed); amendment 2: policy gate where a CNI enforces asynchronously; amendment 3 (2026-09-24): the FQDN layer replaces the coarse public rule; a host canary the pod's own policy drops (review 2 DEP-03, DEP-05) |
